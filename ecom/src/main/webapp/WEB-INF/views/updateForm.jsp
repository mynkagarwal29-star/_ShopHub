                ...
                <form action="/updateProduct" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="category" name="category" required
                                ...
                                <option value="<%= cat.getCategory() %>"
                                        <%= cat.getCategory().equals(product.getCategory()) ? "selected" : "" %>>
                                    <%= cat.getCategory() %>
                                </option>
                                <%
                                        }
                    ...
                    <div class="row form-row">
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="quantity" name="quantity"
                                   value="<%= product.getQuantity() %>" min="1" required>
                        </div>

                        <div class="col-md-6">
                            <label for="price" class="form-label required">Price ($)</label>
                            <input type="number" class="form-control" id="price" name="price"
                                   value="<%= product.getPrice() %>" step="0.01" min="0.01" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <textarea class="form-control" id="description" name="description"
                                  rows="4" maxlength="10000" required><%= product.getDescription() %></textarea>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", () => {
        updateCounter(nameInput, nameCounter, 250);
        updateCounter(descInput, descCounter, 10000);
    });
